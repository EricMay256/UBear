...
namespace UnityCSharpStyleSheetExample
{
    ...
    public class StyleExample : MonoBehaviour
    {
        ...
        // Unity likes to have a function designated to reset static variables, so we can use a static constructor for that.
        ...
        // To silently succeed while reporting failures, use Debug.Assert.
